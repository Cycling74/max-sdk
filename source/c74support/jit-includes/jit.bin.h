...
// misc constants
enum {
	JIT_BIN_MAC_TYPE  				= FOUR_CHAR('JiT!'),

	JIT_BIN_VERSION_1 				= 0x3C93DC80, //2002/03/17 00:00:00 UTC

	JIT_BIN_CHUNK_CONTAINER  		= FOUR_CHAR('FORM'),
	JIT_BIN_CHUNK_FORMAT_VERSION  	= FOUR_CHAR('FVER'),
	JIT_BIN_CHUNK_MATRIX  			= FOUR_CHAR('MTRX'),

	JIT_BIN_FORMAT  				= FOUR_CHAR('JIT!'),

	JIT_BIN_FILESIZE_UNKNOWN  		= 0xFFFFFFFF,

	JIT_BIN_TYPE_CHAR  				= FOUR_CHAR('CHAR'),
	JIT_BIN_TYPE_LONG  				= FOUR_CHAR('LONG'),
	JIT_BIN_TYPE_FLOAT32  			= FOUR_CHAR('FL32'),
	JIT_BIN_TYPE_FLOAT64  			= FOUR_CHAR('FL64'),

	JIT_BIN_HEADER_SIZE				= (6*SIZE_INT32),
	JIT_BIN_CKINFO_SIZE				= (2*SIZE_INT32)
};
