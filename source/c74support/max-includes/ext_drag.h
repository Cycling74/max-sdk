...
t_object *jdrag_createnewobj(t_object *dg, t_object *pv, char *classname, char *str, long dragobjectindex);
t_object *jdrag_createmessage(t_object *dg, t_object *pv, t_symbol *msg, long ac, t_atom *av, long dragobjectindex);
...
void jdrag_add(t_object *dg, t_object *rcv, t_symbol *msg, const char *desc, void *arg);

// same as jdrag_add but msg will be sent to rcv for each file in the drag-n-drop
// when using jdrag_add() version caller must iterate directly using jdrag_itemcount, etc.
void jdrag_add_iterated(t_object *dg, t_object *rcv, t_symbol *msg, const char *desc, void *arg);
