...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 23.0, 388.0, 80.0, 36.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 23.0, 311.0, 80.0, 36.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 148.0, 311.0, 80.0, 36.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 86.0, 493.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 118.0, 388.0, 87.0, 23.0 ],
									"style" : "",
									"text" : "jit.alphablend"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 418.0, 118.0, 230.0, 125.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 118.0, 354.0, 204.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 299.0, 388.0, 315.0, 50.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 65.0, 218.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 118.0, 259.0, 219.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 118.0, 118.0, 230.0, 125.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 154.390625, 53.625 ]
								}
...
, 							{
								"box" : 								{
									...
									"onscreen" : 0,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 118.0, 424.0, 160.0, 120.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 427.5, 379.0, 195.5, 379.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 275.0, 92.0, 18.0 ],
					"style" : "",
					"text" : "resize 700 640"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 324.0, 123.0, 20.0 ],
					"saved_object_attributes" : 					{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 68.0, 140.0, 230.0, 125.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 68.0, 519.0, 80.0, 36.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 186.0, 311.0, 112.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 68.0, 344.0, 118.0, 23.0 ],
									"style" : "",
									"text" : "jit.pack 4"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 68.0, 282.0, 136.0, 23.0 ],
									"style" : "",
									"text" : "jit.unpack 4"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 187.0, 344.0, 120.687401, 39.0 ],
									"presentation_rect" : [ 187.0, 344.0, 120.687401, 39.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"onscreen" : 0,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 68.0, 390.0, 160.0, 120.0 ]
								}
